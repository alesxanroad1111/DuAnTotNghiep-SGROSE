                ...
                <div class="product-details">
                    ...
                    <div class="col-sm-5">
                        <div class="view-product">
                            <img src="images/hoa/${p.flowerId.image}" alt="${p.flowerId.name}" />
                            <h3>Sale</h3>
                        </div>
                    ...
                    <div class="col-sm-7">
                        <div class="product-information">
                            ...
                            <div class="row">
                                    ...
                                    <span>
                                        <rt:choose>
                                            <rt:when test="${p.typeprice == 0}">
                                                <h4>Giảm: <fmt:formatNumber value = "${p.typePercent}" type = "number"/>%</h4>
                                                <span>Giá: <fmt:setLocale value = "en_US"/><fmt:formatNumber value = "${p.flowerId.price * ((100-p.typePercent)/100)}" type = "number"/>₫</span>
                                            </rt:when>
                                            <rt:when test="${p.typePercent == 0}">
                                                <h4>Giảm: <fmt:formatNumber value = "${p.typeprice}" type = "number"/>₫</h4>
                                                <span>Còn: <fmt:setLocale value = "en_US"/><fmt:formatNumber value = "${p.flowerId.price - p.typeprice}" type = "number"/>₫</span>
                                            </rt:when>
                                        </rt:choose>
                                ...
                                <div class="col-sm-4">
                                    <a href="user/buy/${p.flowerId.id}.htm?yeucau=muasp&txtmasp=${p.flowerId.id}" class="btn btn-fefault cart">
                ...
                <div class="category-tab shop-details-tab">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active in" id="details">
                            <div class="col-sm-11">
                                <h2 class="display-4" style="color: #ec4c76;">${p.flowerId.name}</h2>
                                <p>${p.flowerId.notes}</p>
                            </div>
                            <div class="col-sm-11 text-center">
                                <img src="images/hoa/${p.flowerId.image}" alt="${p.flowerId.image}"/>
                            </div>
