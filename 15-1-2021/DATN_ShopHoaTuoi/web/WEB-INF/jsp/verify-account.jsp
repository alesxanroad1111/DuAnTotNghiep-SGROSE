        ...
        <div class="limiter">
            ...
            <div class="container-login100">
                ...
                <div class="wrap-login100">
                    ...
                    <form class="login100-form " action="verify-account2" method="post">
                        <span class="login100-form-title">
                            STEP 2: VERIFY YOUR ACCOUNT
                        </span>
                        <span class="text-warning">Chúng tôi vừa gửi một mã xác minh đến hộp thư email <span class="text-primary">${verifyemail}</span>. Xin vui lòng kiểm tra hộp thư của bạn.</span>
                        <style>
                            .flexContainer {
                                display: flex;
                            }
                        ...
                        <div class="wrap-input100 validate-input flexContainer">
                            <input name="code" class="input100 inputField" placeholder="Mã xác minh">
