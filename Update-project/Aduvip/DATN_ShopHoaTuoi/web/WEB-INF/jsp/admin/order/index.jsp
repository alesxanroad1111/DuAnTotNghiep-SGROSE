                                ...
                                <tbody >
                                    <c:forEach var="az" items="${orderstatus2}">
                                        <tr>
                                            ...
                                            <td><a href="admin/order/edit/show/${az.id}.htm"><img src="https://img.icons8.com/nolan/50/edit.png" width="31"/></a></td>
                                            <td><a href="admin/order/edit/delete1/${az.id}.htm"><img src="https://img.icons8.com/nolan/64/delete-sign.png" width="31"/></td>
                                            <td><a href="admin/order/details/${az.id}.htm"><img src="https://img.icons8.com/flat_round/64/000000/info.png" width="31" /></a></td>
                                        </tr>
                                    </c:forEach>
                                </tbody>
