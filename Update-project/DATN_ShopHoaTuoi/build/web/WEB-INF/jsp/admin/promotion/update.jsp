        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form:form action="admin/promotion/insert.htm" modelAttribute="promotion" method="GET">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <form:input path="discountId.id" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label >Mã tên hoa</label><br>
                                        <form:input path="flowerId.id" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <a class="btn btn-success" href="admin/promotion/index.htm">Cancel</a>
