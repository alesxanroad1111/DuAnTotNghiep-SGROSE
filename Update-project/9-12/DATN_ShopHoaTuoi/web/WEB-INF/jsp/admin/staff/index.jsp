...
<div class="content">
    <a class="btn btn-success btn-hover" href="admin/staff/update">add</a>
                    ...
                    <tbody>
                         <c:forEach var="rows" items="${staffs}">
                            <tr>
                                ...
                                <td> <a href="admin/staff/edit0/${rows.id}"><img src="https://img.icons8.com/nolan/50/edit.png" width="31"/></a></td>
                                 <td><a href="admin/staff/delete0/${rows.id}"><img src="https://img.icons8.com/nolan/64/delete-sign.png" width="31"/></td>
