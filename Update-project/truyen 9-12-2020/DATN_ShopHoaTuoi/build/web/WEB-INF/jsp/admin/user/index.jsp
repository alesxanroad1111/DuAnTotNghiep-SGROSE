                                ...
                                <tbody >
                                    <c:forEach var="u" items="${users}">
                                        <tr>
                                            ...
                                            <td> <a href="admin/user/edit/${u.id}"><img src="https://img.icons8.com/nolan/50/edit.png" width="31"/></a></td>
                                            <td><a href="admin/user/delete2/${u.id}"><img src="https://img.icons8.com/nolan/64/delete-sign.png" width="31"/></td>
