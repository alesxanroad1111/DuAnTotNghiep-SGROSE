...
//            errors.rejectValue("Userid", "order", "Vui lòng nhập Userid");
//        }
//        if (order.getAddress().trim().length() == 0) {
//        errors.rejectValue("Address", "order", "Không được để trống !");
//        }
//        if(order.getTotalmoney() == 0){
//        errors.rejectValue("Totalmoney", "order", "Vui lòng nhập tổng tiền !");
//        }
        try {
            session.save(order);
            t.commit();
