...
//    }
    ...
    public String Active(ModelMap model, @ModelAttribute("user") User user) {
        Session session = factory.openSession();
        Transaction t = session.beginTransaction();
    ...
    @RequestMapping(value = "edit", method = RequestMethod.GET, params = "btnban")
    public String Ban(ModelMap model, @ModelAttribute("user") User user) {
        Session session = factory.openSession();
        Transaction t = session.beginTransaction();
