        ...
        <div class="row">
            ...
            <div class="col-sm-9" style="margin-bottom: 100px;">
                <div class="row">
                    ...
                    ${message}
                    <form:form class="form-horizontal" action="${pageContext.request.contextPath}/user/update-your-profile.htm" modelAttribute="userr" method="POST">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8 shopper">
                                    <input path="birthday" name="birthday" type="text" value="${user.birthday}" id="birthDate" class="form-control"/>
                                </div>
                            </div>
                            <div class="form-group row">
